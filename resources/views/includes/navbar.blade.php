            ...
            <div class="site-width">
                ...
                <ul id="side-menu" class="sidebar-menu">
                    <li class="dropdown"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>
                        <ul>
                            <li><a href="{{url('home')}}"><i class="icon-rocket"></i> Dashboard</a></li>
                    ...
                    <li class="dropdown"><a href="#"><i class="icon-layers mr-1"></i> Web Apps</a>
                        <ul>
                            <li><a href="{{url('first-formView')}}"><i class="icon-calendar"></i> Form</a></li>
                            <li><a href="{{url('first-form-tableView')}}"><i class="icon-speech"></i> Tables</a></li>
                            <li><a href="{{url('create-invoice')}}"><i class="icon-support"></i> Invoice</a></li>
